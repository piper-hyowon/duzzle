...
export interface BlueprintItemInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'DEFAULT_ADMIN_ROLE'
      | 'MINTER_ROLE'
...
export interface BlueprintItem extends BaseContract {
  connect(runner?: ContractRunner | null): BlueprintItem;
  waitForDeployment(): Promise<this>;

  interface: BlueprintItemInterface;
  ...
  mint: TypedContractMethod<
    [_to: AddressLike, tokenId: BigNumberish],
    [bigint],
    'nonpayable'
  >;
