...
export interface MaterialItemInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'DEFAULT_ADMIN_ROLE'
      | 'MINTER_ROLE'
...
export interface MaterialItem extends BaseContract {
  connect(runner?: ContractRunner | null): MaterialItem;
  waitForDeployment(): Promise<this>;

  interface: MaterialItemInterface;
