...
export interface PuzzlePieceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'DEFAULT_ADMIN_ROLE'
      | 'MINTER_ROLE'
...
export interface PuzzlePiece extends BaseContract {
  connect(runner?: ContractRunner | null): PuzzlePiece;
